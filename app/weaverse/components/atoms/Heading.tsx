...
let variants = cva('heading font-heading', {
    variants: {
        size: {
            default: '',
            custom: '',
...
export let headingInputs: InspectorGroup['inputs'] = [
    ...
    },
    {
        ...
        condition: 'size.eq.scale',
        helpText:
            'Se hur textstorlek fungerar <a href="https://css-tricks.com/snippets/css/fluid-typography/" target="_blank" rel="noreferrer">här</a>.',
    },
    {
        type: 'select',
        name: 'mobileSize',
        label: 'Textstorlek - Mobil',
        condition: 'size.eq.custom',
        configs: {
            options: [
                { value: 'xs', label: 'Extra liten (text-xs)' },
                { value: 'sm', label: 'Liten (text-sm)' },
                { value: 'base', label: 'Bas (text-base)' },
                { value: 'lg', label: 'Stor (text-lg)' },
                { value: 'xl', label: 'Extra stor (text-xl)' },
                { value: '2xl', label: '2x stor (text-2xl)' },
                { value: '3xl', label: '3x stor (text-3xl)' },
                { value: '4xl', label: '4x stor (text-4xl)' },
                { value: '5xl', label: '5x stor (text-5xl)' },
                { value: '6xl', label: '6x stor (text-6xl)' },
                { value: '7xl', label: '7x stor (text-7xl)' },
                { value: '8xl', label: '8x stor (text-8xl)' },
                { value: '9xl', label: '9x stor (text-9xl)' },
            ],
        },
        defaultValue: '3xl',
    },
