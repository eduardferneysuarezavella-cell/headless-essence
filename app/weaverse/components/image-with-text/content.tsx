...
let variants = cva(
    "grow h-auto basis-full md:basis-1/2 flex flex-col justify-start gap-5 px-4 md:px-8 [&_.paragraph]:mx-[unset] [&_.paragraph]:w-full",
    {
        variants: {
            alignment: {
                left: "items-start",
...
export let schema: HydrogenComponentSchema = {
    ...
    childTypes: ["subheading-other", "heading-other", "description", "button"],
};