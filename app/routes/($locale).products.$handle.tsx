...
import { Await, Link, useLoaderData, useNavigate, useRoutes, type MetaFunction, useLocation } from '@remix-run/react';
                ...
                <div className='max-w-[1440px] mx-auto lg:pb-12 pb-8'>
                    ...
                    <div className='product-page pt-5'>
                        ...
                        <div className="product-main lg:pt-16">
                            ...
                            {product.type?.value === 'Parfym' || product.type?.value === 'Perfume' && (
                                <Notes
                                    topNotes={topNotes}
                                    baseNotes={baseNotes}
                            ...
                            <div className='px-5'>
                                <div className='pb-6 '>
                                    <div className='flex justify-between items-center'>
                                        <h2 className='font-heading lg:text-3xl text-2xl font-semibold w-1/2'>{_('product.sections.seeAllKits.title.testers')}</h2>
                                ...
                                <div className='flex lg:flex-row flex-col'>
                                    ...
                                    <div className='flex flex-col gap-2 pt-4 px-5 lg:p-16'>
                                        ...
                                        <InnerProductForm
                                            ...
                                            variants={additionalData.testers?.product?.variants.nodes}
                                            price={additionalData.testers?.product?.variants.nodes[0].price}
                                            description={_('product.sections.fillNecessaire.description')}
                                        />
