        ...
        results.push({
            ...
            items: predictiveSearch.products.map((product: PredictiveProductFragment) => {
                ...
                return {
                    ...
                    url: `/products/${product.handle}${trackingParams}`,
            ...
            items: predictiveSearch.articles.map(
                (article: PredictiveArticleFragment) => {
                    ...
                    return {
                        ...
                        title: article.title,
                        url: `/blogs/${article.blog.handle}/${article.handle}${trackingParams}`,
                    };
                },
            ),
        });
            ...
            items: predictiveSearch.pages.map(
                (page: PredictivePageFragment) => {
                    ...
                    return {
                        ...
                        id: page.id,
                        title: page.title,
                        url: page.handle === 'doftfamiljer'
                            ? `/${page.handle}${trackingParams}`
                            : `/pages/${page.handle}${trackingParams}`,
                    };
                },
            ),
        });
            ...
            items: predictiveSearch.collections.map(
                (collection: PredictiveCollectionFragment) => {
                    ...
                    return {
                        ...
                        url: `/collections/${collection.handle}${trackingParams}`,
                    };
                },
            ),
        });
